"""__init__.py
Test suites for the sqlalchemyobjects package.

Contains test suites for the sqlalchemyobjects package. It provides a structured testing framework to ensure the
functionality and reliability of the sqlalchemyobjects components and is a basis for creating tests for hierarchies of
components.
"""
